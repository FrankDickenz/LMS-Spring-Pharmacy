...
urlpatterns = [
    ...
    path('<str:username>/<int:course_id>/section/<int:section_id>/report/',views.submit_report, name='submit_report'),
    path('grade-distribution/<int:course_id>/', views.grade_distribution_view, name='grade_distribution')
