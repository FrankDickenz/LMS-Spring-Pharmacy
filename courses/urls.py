...
from . import views
from .views import CourseAutocomplete,InstructorAutocomplete,PartnerAutocomplete,SectionViewSet,MaterialViewSet,AssessmentViewSet
app_name = 'courses'
...
urlpatterns = [
    ...
    path('instructor-all/', views.instructor_view, name='instructor_view'),
    ...
    path('course/<int:course_id>/team/remove/<int:member_id>/', views.course_team_remove, name='course_team_remove'),
