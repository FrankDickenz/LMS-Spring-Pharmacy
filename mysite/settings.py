...
# ALLOWED_REFERER = 'https://your-production-domain.com'
#=============================== end production ===============================
...
SITE_URL = 'http://your-production-domain.com'
...
CONTENT_SECURITY_POLICY = {
    'DIRECTIVES': {
        ...
        'img-src': (
            "'self'",
            "data:",
              "",  # misalnya untuk gambar yang di-embed sebagai base64
        ),
        ...
        'form-action': (
            "'self'",
            "https://your-production-domain lti.com",  # domain Moodle tujuan POST LTI
...
LTI_ISSUER = "https://your-production-domain.com"  # domain lms to lti
LTI_CLIENT_ID = "your-client-id"  # Sesuaikan dengan data dari H5P
